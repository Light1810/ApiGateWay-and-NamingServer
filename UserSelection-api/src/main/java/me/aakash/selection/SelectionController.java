...
public class SelectionController {
	...
	{
	return resttemplate.getForObject("http://user-database/user/"+mobNo, User_info.class);
	}
	...
	public Demo_voi_icon getop1(@PathVariable("id")long mobNo) {
		...
		int o1=usop.getO1();
		return resttemplate.getForObject("http://icon-database/icon/id/"+o1,Demo_voi_icon.class);
	}
	...
	public Demo_voi_icon getop2(@PathVariable("id")long mobNo) {
		Useroptions usop=selectionservice.getbynumber(mobNo);
		int o2=usop.getO2();
		return resttemplate.getForObject("http://icon-database/icon/id/"+o2,Demo_voi_icon.class);
	}
	...
	public Demo_voi_icon getop3(@PathVariable("id")long mobNo) {
		Useroptions usop=selectionservice.getbynumber(mobNo);
		int o3=usop.getO3();
		return resttemplate.getForObject("http://icon-database/icon/id/"+o3,Demo_voi_icon.class);
	}
	...
	public Demo_voi_icon getop4(@PathVariable("id")long mobNo) {
		Useroptions usop=selectionservice.getbynumber(mobNo);
		int o4=usop.getO4();
		return resttemplate.getForObject("http://icon-database/icon/id/"+o4,Demo_voi_icon.class);
	}
   ...
   public CustomData getallinfo(@PathVariable("id")long mobNo) {
		...
		User_info userinfo=resttemplate.getForObject("http://user-database/user/"+mobNo, User_info.class);
		Demo_voi_icon icon1=resttemplate.getForObject("http://icon-database/icon/id/"+o1,Demo_voi_icon.class);
		Demo_voi_icon icon2=resttemplate.getForObject("http://icon-database/icon/id/"+o2,Demo_voi_icon.class);
		Demo_voi_icon icon3=resttemplate.getForObject("http://icon-database/icon/id/"+o3,Demo_voi_icon.class);
		Demo_voi_icon icon4=resttemplate.getForObject("http://icon-database/icon/id/"+o4,Demo_voi_icon.class);
